<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="azmayeshgah.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <!-- role name -->
         <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Role" CssClass="col-md-2 control-label">User Type</asp:Label>
            <div class="col-md-10">
